...
def process_ros2_controllers_config(context):
    ...
    pkg_share = FindPackageShare(package='yahboom_rosmaster_description').find('yahboom_rosmaster_description')
    
    # Define source and install config paths
    src_config_path = os.path.join(pkg_share, 'config', robot_name)
    install_config_path = os.path.join(
        home,
        'study/ros/yahboom_rosmaster/yahboom_rosmaster_ws/install/yahboom_rosmaster_description/share/yahboom_rosmaster_description/config',
        robot_name
    )
