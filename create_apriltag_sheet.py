...
def create_apriltag_sheet():
    """Create a single A4 sheet with all 5 AprilTags arranged in a grid"""
    ...
    # Load all 5 AprilTag images
    tag_files = [
        'apriltag_36h11_id_00.png',
        'apriltag_36h11_id_01.png',
        'apriltag_36h11_id_02.png',
        'apriltag_36h11_id_03.png',
        'apriltag_36h11_id_04.png'
    ]
    
    # Load and place tags on the sheet
    tags = []
    for filename in tag_files:
        filepath = os.path.join('apriltag_images', filename)
    ...
    # Add some margin around the sheet
    margin = 100
    ...
    # Add title
    title = "AprilTags 36h11 (ID 0-4)"
    title_pos = (a4_width//2 - 200, 50)
    cv2.putText(a4_sheet, title, title_pos, cv2.FONT_HERSHEY_SIMPLEX, 
               2, (0, 0, 0), 3, cv2.LINE_AA)
    
    # Save the combined sheet
    output_path = "apriltag_a4_sheet.png"
    cv2.imwrite(output_path, a4_sheet)
    print(f"A4 sheet with all AprilTags saved as {output_path}")
